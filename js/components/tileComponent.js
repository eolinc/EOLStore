 ...
 *
 * Visual style: each tile sits inside a sunken Windows 95-style "well"
 * (.eol-tile-slot, win95-sunken) - a recessed frame behind it - with the
 * tile itself a raised 3D button (.win95-raised) on top, and the app's
 * own art shown as a smaller centered "chip". The button chrome stays
 * neutral grey; the chip carries the per-app color/icon.
 */
const TileComponent = (function () {
  ...
  function renderTile(app) {
    const priceBadge = app.price && app.price !== "Free"
      ...
      : "";
    return `
      <div class="eol-tile-slot win95-sunken">
